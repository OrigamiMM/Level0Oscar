...
public class AnimalJumping {
	public static void main(String[] args) throws MalformedURLException {
		...
		String urlOfAnimalSuckingAtJumping = "Cat Fail";
		Frame.setVisible(true);
		Frame.add(createImage("http://66.media.tumblr.com/fb876f3b0bd087d90343e2af61f28b8c/tumblr_nlgpkxfK8P1s612eao1_500.gif"));
